...
import { BannerCard01 } from '@ikea/components/molecules/BannerCard01/BannerCard01'
import { CardCategory01 } from '@ikea/components/molecules/CardCategory01/CardCategory01'
import { ColorCard } from '@ikea/components/molecules/ColorCard/ColorCard'
import HScroll from '@ikea/components/molecules/HScroll'
import { sampleImages } from '@ikea/components/templates/Masonry2/data'
import { PriceMarker } from '@ikea/components/molecules/PriceMarker/PriceMarker'
import { ProductCard01 } from '@ikea/components/molecules/ProductCard01'
import { AdBanner } from '@ikea/components/organisms/AdBanner/AdBanner'
import { HomeBanner } from '@ikea/components/organisms/HomeBanner'
import { Masonry2 } from '@ikea/components/templates/Masonry2'
import { Image } from '@ikea/components/atoms/Image'

import { InfoCard } from '@ikea/components/molecules/InfoCard'
import Link from 'next/link'
import { DeveloperCommentary } from '@ikea/components/molecules/DeveloperCommentary/DeveloperCommentary'
    ...
    <Container className="mt-24 space-y-24">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-responsive">
          <ProductCard01 product={sampleProduct} />
          <ProductCard01 product={sampleProduct} />
          <ProductCard01 product={sampleProduct} />
          <ProductCard01 product={sampleProduct} />
        </div>
