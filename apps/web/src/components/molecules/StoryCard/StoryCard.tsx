...
const StoryParent = ({ children }: { children: ReactNode }) => (
  <div className="grid grid-cols-1 grid-rows-10 sm:grid-cols-5 sm:grid-rows-1">
    {children}
  </div>
)

const StoryImage = ({ children }: { children: ReactNode }) => (
...
const StoryContent = ({ children }: { children: ReactNode }) => (
...
const StoryDescription = ({ children }: { children: ReactNode }) => {
...
export const StoryCard = ({ src, title, description }: IStoryCardProps) => (
  <StoryParent>
    <StoryContent>
